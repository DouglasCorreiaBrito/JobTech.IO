...
public class SkillController {
    ...
    public ResponseEntity<List<SkillResponse>> filterByDescription(@Valid @PathVariable String description) {
        return ResponseEntity
                .ok(service.listByDescription(description).stream().map(x -> mapper.entityToDto(x)).collect(Collectors.toList()));
    }
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<SkillResponse> put(@Valid @RequestBody SkillRequest model,
